...
public class TransationHistoryActivity extends AppCompatActivity implements MyBrowser.MyBrowserListener{

    private String URL = "https://xmpp.org/software/servers.html";
