...
/**
 * Created by testkart on 20/5/17.
 */

public class ResultViewActivity extends AppCompatActivity implements MyBrowser.MyBrowserListener{
    ...
    private void initialization() {
        ...
        URL = getIntent().getStringExtra(ExamActivity.KEY_DISPLAY_RESULT);
