...
public class UpcomingExamFragment extends Fragment implements ExamListAdapter.ExamListActionListener{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //progressDialog.setTitle("Upcoming Exam");
        ...
        viewExamList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(mListener != null){
                    ...
                    mListener.onExamSelect(exam, false);
                }


               // Toast.makeText(getContext(), "Only view", Toast.LENGTH_SHORT).show();
            }
        });
    }*/
    ...
    private void makeAPiCall() {
        ...
        Call<ExamListResponse> call = apiService.getUpcomingExam(session.getUserDetails().get(SessionManager.KEY_PUBLIC),
                ...
                if(code == 200){
                    ...
                    if(response.body().getStatus()){
                        ...
                        if(response.body().getResponse().isEmpty()){
                            ...
                            ExamListAdapter adapter = new ExamListAdapter(getContext(), dataSet, 3, false);
