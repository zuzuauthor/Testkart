...
public class ExpiredExamFragment extends Fragment implements ExamListAdapter.ExamListActionListener{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
      ...
      //  progressDialog.setTitle("Expired Exam");
    ...
    private void makeAPiCall() {
        ...
        Call<ExamListResponse> call = apiService.getExpiredExam(session.getUserDetails().get(SessionManager.KEY_PUBLIC),
                ...
                if(code == 200){
                    ...
                    if(response.body().getStatus()){
                        ...
                        if(response.body().getResponse().isEmpty()){
                            ...
                            ExamListAdapter adapter = new ExamListAdapter(getContext(), dataSet, 4, false);
