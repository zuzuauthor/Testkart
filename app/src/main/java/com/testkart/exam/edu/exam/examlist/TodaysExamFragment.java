...
public class TodaysExamFragment extends Fragment implements ExamListAdapter.ExamListActionListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
       ...
       // progressDialog.setTitle("Today's Exam");
...
/*    private void viewExamListListener() {
                ...
                if(code == 200){
                    ...
                    if(response.body().getStatus()){
                        ...
                        if(response.body().getResponse().isEmpty()){
                            ...
                            for (com.testkart.exam.edu.exam.examlist.Response r:
                            ...
                            ExamListAdapter adapter = new ExamListAdapter(getContext(), dataSet, 1, true);
    ...
    public void onTakeExam(Exam exam, boolean canTakeExam) {
        ...
        if(mListener != null){
            ...
            mListener.onExamSelect(exam, true, 1);
        }
