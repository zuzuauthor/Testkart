package com.testkart.exam.banking_digest.buy;
...
import com.testkart.exam.banking_digest.buy.model.Magazine;
...
import com.testkart.exam.packages.PackageDetailDialog;
import com.testkart.exam.packages.PackageFilterDialog;
import com.testkart.exam.packages.PackageGridAdapter;
import com.testkart.exam.packages.ShoppingCartActivity;
import com.testkart.exam.packages.SimpleGestureFilter;
...
public class MagazinesListActivity extends BaseActivity implements PackageFilterDialog.FilterListener, PackageDetailDialog.OnPackageActionListener, SimpleGestureFilter.SimpleGestureListener {
    ...
    public static MagazinesListActivity act;
    ...
    private void initialization() {
        ...
        viewActionTitle.setText("Magazines");
        ...
        featureExam1 = findViewById(R.id.featureExam1);
        featureExam2 = findViewById(R.id.featureExam2);
        featureExam3 = findViewById(R.id.featureExam3);
    ...
    private void makeAPiCall(final int filterType, final String filterValue, final boolean isFilter) {
        ...
        Call<MagazinesResponse> call = null;
        ...
        if(isFilter){
            ...
            call = apiService.getAllMagazines("http://www.testkart.com/rest/MagazinePackages/index.json");
        }


        call.enqueue(new Callback<MagazinesResponse>() {
            @Override
                    ...
                    if (response.body() != null) {
                        ...
                        if (response.body().getStatus()) {
                            ...
                            if (!response.body().getResponse().isEmpty()) {
                                ...
                                for (com.testkart.exam.banking_digest.buy.model.Response r :
                                    ...
                                    pdm.setPackageId(r.getMagazinePackage().getId());
                                    pdm.setPackageName((r.getMagazinePackage().getName() != null) ? r.getMagazinePackage().getName() : "");

                                    carttem.setPackageId(r.getMagazinePackage().getId());
                                    carttem.setPackageName((r.getMagazinePackage().getName() != null) ? r.getMagazinePackage().getName() : "");
                                    carttem.setPackageDescription((r.getMagazinePackage().getDescription() != null) ? r.getMagazinePackage().getDescription() : "");
                                    carttem.setPackageAmount((r.getMagazinePackage().getAmount() != null) ? r.getMagazinePackage().getAmount() : "");
                                    carttem.setPackageSHowAmount((r.getMagazinePackage().getShowAmount() != null) ? r.getMagazinePackage().getShowAmount() : "");
                                    carttem.setPackageExpiryDays((r.getMagazinePackage().getExpiryDays() != null) ? r.getMagazinePackage().getExpiryDays() : "");
                                    carttem.setPackageStatus((r.getMagazinePackage().getStatus() != null) ? r.getMagazinePackage().getStatus() : "");
                                    carttem.setPackageCreated((r.getMagazinePackage().getCreated() != null) ? r.getMagazinePackage().getCreated() : "");
                                    carttem.setPackageModify((r.getMagazinePackage().getModified() != null) ? r.getMagazinePackage().getModified() : "");
                                    carttem.setPackageImage((r.getMagazinePackage().getPhoto() != null) ? (String) r.getMagazinePackage().getPhoto() : "");
                                    carttem.setItemAddedToCart(false);

                                    carttem.setPackageOrdering((r.getMagazinePackage().getOrdering() != null) ? (String) r.getMagazinePackage().getOrdering() : "0");
        ...
        actGridPackages.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!ci.isItemAddedToCart()){
                    ...
                    startActivityForResult(packageDetailActivity, 1001);
